...
stats["laser"] = {
    ...
    "PVE_base": function () {
        return [(nanToZero(bonuses["damage_PVE_laser_ship"]) + (nanToZero(bonuses["damage_PVE_laser_drone"]) * (1 + nanToZero(bonuses["damage_%_havoc_set_drone"]) * 0.01))) - (nanToZero(bonuses["damage_PVE_laser_ship"]) + (nanToZero(bonuses["damage_PVE_laser_drone"]) * (1 + nanToZero(bonuses["damage_%_havoc_set_drone"]) * 0.01))) * this["fluctuating_%"]() * 0.01,
            (nanToZero(bonuses["damage_PVE_laser_ship"]) + (nanToZero(bonuses["damage_PVE_laser_drone"]) * (1 + nanToZero(bonuses["damage_%_havoc_set_drone"]) * 0.01)))]
    },
    "PVE_%": function () {
    ...
    "PVP_base": function () {
        return [(nanToZero(bonuses["damage_PVP_laser_ship"]) + (nanToZero(bonuses["damage_PVP_laser_drone"]) * (1 + nanToZero(bonuses["damage_%_havoc_set_drone"]) * 0.01))) - (nanToZero(bonuses["damage_PVP_laser_ship"]) + (nanToZero(bonuses["damage_PVP_laser_drone"]) * (1 + nanToZero(bonuses["damage_%_havoc_set_drone"]) * 0.01))) * this["fluctuating_%"]() * 0.01,
            (nanToZero(bonuses["damage_PVP_laser_ship"]) + (nanToZero(bonuses["damage_PVP_laser_drone"]) * (1 + nanToZero(bonuses["damage_%_havoc_set_drone"]) * 0.01)))]
    },
    "PVP_%": function () {
    ...
    "bonus_PVE": function () {
        return [((nanToZero(bonuses["damage_bonus_laser_ship"]) + (nanToZero(bonuses["damage_bonus_laser_drone"]) * (1 + nanToZero(bonuses["damage_%_havoc_set_drone"]) * 0.01))) * (1 + this["PVE_%"]() * 0.01)) - ((nanToZero(bonuses["damage_bonus_laser_ship"]) + (nanToZero(bonuses["damage_bonus_laser_drone"]) * (1 + nanToZero(bonuses["damage_%_havoc_set_drone"]) * 0.01))) * (1 + this["PVE_%"]() * 0.01)) * this["fluctuating_%"]() * 0.01,
            (nanToZero(bonuses["damage_bonus_laser_ship"]) + (nanToZero(bonuses["damage_bonus_laser_drone"]) * (1 + nanToZero(bonuses["damage_%_havoc_set_drone"]) * 0.01))) * (1 + this["PVE_%"]() * 0.01)]
    },
    "bonus_PVP": function () {
        return [((nanToZero(bonuses["damage_bonus_laser_ship"]) + (nanToZero(bonuses["damage_bonus_laser_drone"]) * (1 + nanToZero(bonuses["damage_%_havoc_set_drone"]) * 0.01))) * (1 + this["PVP_%"]() * 0.01)) - ((nanToZero(bonuses["damage_bonus_laser_ship"]) + (nanToZero(bonuses["damage_bonus_laser_drone"]) * (1 + nanToZero(bonuses["damage_%_havoc_set_drone"]) * 0.01))) * (1 + this["PVP_%"]() * 0.01)) * this["fluctuating_%"]() * 0.01,
            (nanToZero(bonuses["damage_bonus_laser_ship"]) + (nanToZero(bonuses["damage_bonus_laser_drone"]) * (1 + nanToZero(bonuses["damage_%_havoc_set_drone"]) * 0.01))) * (1 + this["PVP_%"]() * 0.01)]
    },
    "BL": function () {
        return [((nanToZero(bonuses["damage_BL_laser_ship"]) + (nanToZero(bonuses["damage_BL_laser_drone"]) * (1 + nanToZero(bonuses["damage_%_havoc_set_drone"]) * 0.01))) * (1 + this["PVE_%"]() * 0.01)) - ((nanToZero(bonuses["damage_BL_laser_ship"]) + (nanToZero(bonuses["damage_BL_laser_drone"]) * (1 + nanToZero(bonuses["damage_%_havoc_set_drone"]) * 0.01))) * (1 + this["PVE_%"]() * 0.01)) * this["fluctuating_%"]() * 0.01,
            (nanToZero(bonuses["damage_BL_laser_ship"]) + (nanToZero(bonuses["damage_BL_laser_drone"]) * (1 + nanToZero(bonuses["damage_%_havoc_set_drone"]) * 0.01))) * (1 + this["PVE_%"]() * 0.01)]
    },
    "AI": function () {
        return [((nanToZero(bonuses["damage_IA_laser_ship"]) + (nanToZero(bonuses["damage_IA_laser_drone"]) * (1 + nanToZero(bonuses["damage_%_havoc_set_drone"]) * 0.01))) * (1 + this["PVE_%"]() * 0.01)) - ((nanToZero(bonuses["damage_IA_laser_ship"]) + (nanToZero(bonuses["damage_IA_laser_drone"]) * (1 + nanToZero(bonuses["damage_%_havoc_set_drone"]) * 0.01))) * (1 + this["PVE_%"]() * 0.01)) * this["fluctuating_%"]() * 0.01,
            (nanToZero(bonuses["damage_IA_laser_ship"]) + (nanToZero(bonuses["damage_IA_laser_drone"]) * (1 + nanToZero(bonuses["damage_%_havoc_set_drone"]) * 0.01))) * (1 + this["PVE_%"]() * 0.01)]
    },
...
stats["rocket"] = {
    ...
    "reload_time": function () {
        var val = 4 * nanToZero(bonuses["rocket_reload_time_%_formation"]) * 0.01 + 4;
    ...
    "launcher_reload_time": function () {
        var val = 5 * nanToZero(bonuses["launcher_reload_time_%_formation"]) * 0.01 + 5;
...
stats["mine"] = {
    ...
    "reload_time": function () {
        var val = 20 * nanToZero(bonuses["mine_reload_time_%_hermes_set_drone"]) * 0.01 + 20;
        return val
    },
    "radius": function () {
...
stats["hp"] = {
    ...
    "hp_%": function () {
        return ((((nanToZero(bonuses["hp_%_ship"]) + nanToZero(bonuses["hp_%_formation"]) + nanToZero(bonuses["hp_%_module"]) + nanToZero(bonuses["hp_%_infection"]))
            * (1 + (nanToZero(bonuses["hp_%_boost"]) + nanToZero(bonuses["hp_%_laser_ship"]) + nanToZero(bonuses["hp_%_laser_drone"])) * 0.01) + nanToZero(bonuses["hp_%_boost"]) + nanToZero(bonuses["hp_%_laser_ship"]) + nanToZero(bonuses["hp_%_laser_drone"]))
            * (1 + nanToZero(bonuses["hp_%_hercules_set_drone"]) * 0.01) + nanToZero(bonuses["hp_%_hercules_set_drone"]))
            * (1 + (nanToZero(bonuses["hp_%_spartan_drone"]) + nanToZero(bonuses["hp_%_spartan_set_drone"])) * 0.01) + (nanToZero(bonuses["hp_%_spartan_drone"]) + nanToZero(bonuses["hp_%_spartan_set_drone"])))
...
stats["shield"] = {
    ...
    "absorption_%": function () {
        return nanToZero(bonuses["shield_absorption_%_formation"]) + (nanToZero((nanToZero(bonuses["shield_absorption_%_shield_ship"]) + nanToZero(bonuses["shield_absorption_%_shield_drone"])) / this["amount"]()))
    ...
    "regeneration_%": function () {
        return 4
            * (1 + nanToZero(bonuses["shield_regeneration_%_boost"]) * 0.01)
    ...
    "penetration_%": function () {
        return nanToZero(bonuses["shield_penetration_%_ship"])
            + nanToZero(bonuses["shield_penetration_%_formation"])
    }
};

stats["cargo"] = {
    "cargo": function () {
        return this["cargo_base"]() * (1 + this["cargo_%"]() * 0.01)
    },
    "cargo_base": function () {
